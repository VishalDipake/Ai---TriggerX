    ...
    <div style={{ minHeight:'100vh', background:'var(--green-50)', display:'flex', alignItems:'center', justifyContent:'center', padding:'24px' }}>
      <div style={{ width:'100%', maxWidth:'400px' }}>
        ...
        <div style={{ background:'var(--white)', borderRadius:'var(--radius-xl)', border:'1px solid var(--border)', padding:'32px' }}>
          <h2 style={{ fontSize:'20px', fontWeight:'500', color:'var(--gray-800)', marginBottom:'6px' }}>Welcome back</h2>
          <p style={{ fontSize:'13px', color:'var(--gray-600)', marginBottom:'24px' }}>Login to your Flowise account</p>
          ...
          <p style={{ textAlign:'center', marginTop:'20px', fontSize:'13px', color:'var(--gray-600)' }}>
            No account? <Link to="/register" style={{ color:'var(--green-600)', textDecoration:'none', fontWeight:'500' }}>Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
